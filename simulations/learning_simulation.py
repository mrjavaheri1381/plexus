...
class LearningSimulation(TaskManager):
    ...
    def apply_fedscale_traces(self):
        ...
        for node in self.nodes:
            ...
            node.overlays[0].other_nodes_compute = nodes_compute
